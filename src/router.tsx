...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      // Competition Info
      { path: "competition_info", element: <Competition_info /> },
      { path: "add_info", element: <AddInfo /> },
      {
      ...
      { path: "info/add", element: <AddInfo /> },
      { path: "info/alter", element: <AlterPage /> },
      ...
      // OtherInfo
      {
        ...
        children: [
          ...
          { path: "all", element: <Posts category="전체" /> },
          { path: "benefits", element: <Posts category="학교지원" /> },
          { path: "tools", element: <Posts category="개발도구" /> },
